export interface EngineProfile {
  ...
  riskRating: number;
  tuningGraphData?: {stock: { hp: number; nm: number };stage0?: { hp: number; nm: number };stage1: { hp: number; nm: number };stage2: { hp: number; nm: number };stage3?: { hp: number; nm: number };};
  commonIssues: string[];
